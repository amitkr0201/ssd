...
templates['newDeploymentUpdate'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"deployment "
    ...
    + alias2(alias1((depth0 != null ? depth0._modifiedTimeStamp : depth0), depth0))
    ...
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.components : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    </ol>\r\n  </div>\r\n  <div class=\"moreInfo hidden\" id=\""
    + alias2(alias1((depth0 != null ? depth0.deployment_id : depth0), depth0))
    + "\">\r\n    <div class=\"deployment_id\"><span class=\"title\">Deployment ID: </span>"
    + alias2(alias1((depth0 != null ? depth0.deployment_id : depth0), depth0))
    + "</div>\r\n    <div class=\"stackInfo\"><span class=\"title\">Stack #: </span>"
    + alias2(alias1((depth0 != null ? depth0.stackInfo : depth0), depth0))
    + "</div>\r\n    <div class=\"startTime\"><span class=\"title\">Start time: </span>"
    + alias2(alias1((depth0 != null ? depth0._createdTimeStamp : depth0), depth0))
    + "</div>\r\n    <div class=\"endTime\"><span class=\"title\">End time: </span>"
    + alias2(alias1((depth0 != null ? depth0._endTimeStamp : depth0), depth0))
    + "</div>\r\n  </div>\r\n</li>\r\n";
},"2":function(container,depth0,helpers,partials,data) {
    var alias1=container.lambda, alias2=container.escapeExpression;

  return "      <li class=\"component\">\r\n        <div class=\"component paramName\">"
    + alias2(alias1((depth0 != null ? depth0.parameter : depth0), depth0))
    + "</div>\r\n        <div class=\"component paramDesc\">"
    + alias2(alias1((depth0 != null ? depth0.description : depth0), depth0))
    + "</div>\r\n        <div class=\"component paramArtifact\">"
    + alias2(alias1((depth0 != null ? depth0.artifact : depth0), depth0))
    + "</div>\r\n      </li>\r\n";
